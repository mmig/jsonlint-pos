...
case 13:
this.$ = {};
            yy.parser._loc(this.$, _$[$0-1]);//MOD:locInfo empty obj
        
break;
case 14:
this.$ = $$[$0-1];
            yy.parser._loc(this.$, _$[$0-1], '_this');//MOD:locInfo obj
        
break;
case 15:
this.$ = [$$[$0-2], $$[$0]];
            yy.parser._loc(this.$, [_$[$0-2], _$[$0]]);//MOD:locInfo member&value
        
break;
case 16:
this.$ = {}; this.$[$$[$0][0]] = $$[$0][1];
            if(yy.parser.getPos()){
                yy.parser._loc(this.$, _$[$0]);//MOD:locInfo member
                yy.parser._loc(this.$, $$[$0], '_' + $$[$0][0], true);//MOD:locInfo member
            }
...
case 17:
            ...
            if(yy.parser.isStrict()){//MOD: "strict" mode: reject duplicate key entries
                if(typeof $$[$0-2][$$[$0][0]] !== 'undefined'){
                    ...
                    var pos = $$[$0][loc]? $$[$0][loc][0] : _$[$0], posTo;
                    ...
                    posTo = $$[$0-2][loc]? !locDupl? $$[$0-2][loc]['_'+$$[$0][0]][0] : $$[$0-2][loc] : {};
            ...
            yy.parser._loc(this.$, $$[$0], '_' + $$[$0][0], true);//MOD:locInfo member-list
        
break;
case 18:
this.$ = [];
            yy.parser._loc(this.$, [_$[$0-1], _$[$0]]);//MOD:locInfo empty array
        
break;
case 19:
this.$ = $$[$0-1];
            yy.parser._loc(this.$, [_$[$0-2], _$[$0]], '_this');//MOD:locInfo array
        
break;
case 20:
this.$ = [$$[$0]];
            yy.parser._loc(this.$, {'_0': _$[$0]});//MOD:locInfo array-entry
        
break;
case 21:
this.$ = $$[$0-2]; $$[$0-2].push($$[$0]);
            yy.parser._loc(this.$, _$[$0], '_' +  (this.$.length - 1));//MOD:locInfo array-list-entry
