 ...
 * MIT License
**/
var jsonlint = (function(exports){var require=true,module=false;exports=exports||{};/* parser generated by jison 0.4.18 */
/*
...
case 13:
this.$ = {};
            _p._loc(this.$, _$[$0-1]);//MOD:locInfo empty obj
        
break;
case 14:
this.$ = $$[$0-1];
            _p._loc(this.$, _$[$0-1], '_this');//MOD:locInfo obj
        
break;
case 15:
this.$ = [$$[$0-2], $$[$0]];
            _p._loc(this.$, [_$[$0-2], _$[$0]]);//MOD:locInfo member&value
        
break;
case 16:
this.$ = {}; this.$[$$[$0][0]] = $$[$0][1];
            if(_p.getLoc()){
                _p._loc(this.$, _$[$0]);//MOD:locInfo member
                _p._loc(this.$, $$[$0], '_' + $$[$0][0], true);//MOD:locInfo member
            }
...
case 17:
            ...
            if(_p.isStrict()){//MOD: "strict" mode: reject duplicate key entries
                if(typeof $$[$0-2][$$[$0][0]] !== 'undefined'){
                    ...
                    if($$[$0-2]._loc){
                        err._locTo = !locDupl? $$[$0-2][loc]['_'+$$[$0][0]][0] : $$[$0-2][loc];
                    }
                    throw err;
                }
            }//END MOD: "strict" mode
            ...
            _p._loc(this.$, $$[$0], '_' + $$[$0][0], true);//MOD:locInfo member-list
        
break;
case 18:
this.$ = [];
            _p._loc(this.$, [_$[$0-1], _$[$0]]);//MOD:locInfo empty array
        
break;
case 19:
this.$ = $$[$0-1];
            _p._loc(this.$, [_$[$0-2], _$[$0]], '_this');//MOD:locInfo array
